...
class YOLOPredictor: #自己修改代码，记载自己的权重

    def __init__(self, cfg, gpu_id=None):
        # 加载预训练的 YOLO11 模型
        self.model = YOLOv10('/root/autodl-tmp/YOLO11_weight/best.pt') 
        self.detect_names, _, _ = get_class_names(cfg.DEMO.LABEL_FILE_PATH, None, None)
